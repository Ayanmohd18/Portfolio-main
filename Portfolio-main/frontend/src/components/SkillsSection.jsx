...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "MCP (Model Context Protocol)", logo: "https://avatars.githubusercontent.com/u/182288589?s=200&v=4", brandColor: "#3f51b5" },
      { name: "N8N", logo: "https://upload.wikimedia.org/wikipedia/commons/5/53/N8n-logo-new.svg", brandColor: "#6633ff" },
    ],
  },
  {
